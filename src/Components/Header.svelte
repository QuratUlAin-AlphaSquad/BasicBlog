...
<div class="w-full">
    ...
    <div
        class="bg-[#1C1E53] text-white py-32"
    >
        <div class="flex flex-col md:flex-col lg:flex-row justify-center items-center gap-[60px] w-full ">
            <div class="max-w-[582px] flex flex-col gap-12">
                ...
                <p class="xs:text-[12px] font-sans md:text-[16px] font-semibold leading-[28px] opacity-70">
                ...
                <div class="flex flex-row gap-10 ">
                    <button class="bg-[#FCD980]  rounded-full xs:py-2 xs:px-5 md:py-4 md:px-14 text-black">View our work</button>
